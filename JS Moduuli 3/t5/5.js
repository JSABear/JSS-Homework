...
let kohde = document.querySelector('#pictures');
...
for (let i = 0; i < picArray.length; i++){
      ...
      var ht = document.createTextNode(picArray[i].title)
      h.appendChild(ht)

      var f = document.createElement('figure');

      var fc = document.createElement('figcaption');
      var c = document.createTextNode(picArray[i].caption);
      fc.appendChild(c);
      ...
      var t = document.createTextNode(picArray[i]?.description);
      p.appendChild(t)
